...
const Contact = () => {
  return (
    <main className="flex flex-col p-6 shadow-xl items-center justify-center bg-white m-10 rounded-md max-w-md mx-auto text-center">
      ...
      <section className="flex items-center gap-2 text-gray-700 mb-2">
